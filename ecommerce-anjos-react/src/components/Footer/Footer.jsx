          ...
          <div className="footer" id="Footer">
            <div className="footer-box">
              <div className="icon-footer f1">
                <h4>Contato</h4>
                <label>Rua: bla bla bla</label>
                <br />
                <label>Cidade: São Paulo, SP</label>
                <br />
                <label>Cep: blbla79</label>
                <br />
                <label>Telefone: (11) 0000-0000</label>
                <br />
              </div>
              ...
              <div className="icon-footer f3">
                ...
                <input
                  id="emailInput"
                  type="email"
                  placeholder="Mande um email para mim"
                  value={email}
                  onChange={(e) => setEmail(e.target.value)}
                />
                <div className="social-share">
                  <button id="sendEmailBtn" onClick={EnviarEmail}>
                    <img
                      className="imIcon"
                      width="30"
                      height="30"
                  ...
                  <div className="mideia-social">
                    <a
                      href="https://www.instagram.com/anjosgarimpos/"
                      target="_blank"
                    ...
                    <a href="">
                      <img
                        ...
                        width="50"
                        height="50"
                        src="https://img.icons8.com/ios-filled/50/circled-x.png"
                        alt="circled-x"
                      />
                    </a>
                  </div>
